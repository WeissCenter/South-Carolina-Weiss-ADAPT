...
export const environment = {
  ...
  API_URL: 'https://7ofu7w4qrc.execute-api.us-east-1.amazonaws.com/sc-prod/',
  ...
  appDomain: 'adapt-admin.ed.sc.gov',
  enforceLogin: true,
  envLabel: 'Prod',
  enforceRole: true,
  callbackUrl: 'https://adapt-admin.ed.sc.gov/auth/redirect',
  Cognito: {
